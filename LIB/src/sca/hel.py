...
import ctypes
import numpy as np
#lib = ctypes.cdll.LoadLibrary('/home/supelec/Documents/PY3/LIB/libhel.so')   
#lib = ctypes.CDLL('/home/supelec/Documents/PY3/LIB/libhel.so', mode=ctypes.RTLD_GLOBAL)
#lib = ctypes.cdll.LoadLibrary('/home/supelec/Documents/Jeremy/GITs/sca/src/sca/libhel.so')
#lib = ctypes.cdll.LoadLibrary('/home/supelec/Documents/Jeremy/GITs/sca/src/0LD_versions/sca_2023_06/libhel.so')
